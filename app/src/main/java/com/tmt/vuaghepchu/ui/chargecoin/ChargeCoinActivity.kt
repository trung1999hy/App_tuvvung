package com.tmt.vuaghepchu.ui.chargecoin
...
import com.tmt.vuaghepchu.databinding.ActivityChargeCoinScreenBinding
...
class ChargeCoinActivity : AppCompatActivity(), PurchaseInAppAdapter.OnClickListener {
    ...
    private lateinit var binding: ActivityChargeCoinScreenBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_charge_coin_screen)
        initViews()
